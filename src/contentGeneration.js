...
'just desserts':{
  ...
  'agriculture':{
  'slides':['do you, or i, or anyone know\n how oats, peas, beans, and #noun# grow?','in the northern hemisphere,\nearly march is prime #noun# season','pros of genetically modified crops:\n1. bigger \n2. resistant to #gerund#\n3. lovely color','cons of genetically modified crops: \n1. risk of #noun#\n2. "#noun#"\n3. worth the bad press?','never use tractors in fields with #noun#!','#noun# = easy blue ribbon at the state fair','fertilize strawberry fields with #noun#?','you may disagree,\nbut I say radishes are superior to #noun#','leftover biomatter can fuel #noun#','#gerund#: good or bad for your rutabaga fields?','believe it or not,\neggs come from the #noun# of the chicken'],
...
'verb':['pour cereal','juice oranges','eat bacon','fry flapjacks','peel oranges','sizzle','smell that bacon'],
'gerund':['pouring cereal', 'juicing oranges','eating bacon','frying flapjacks','breakfasting','sizzling','smelling that bacon'],
},
'marine biology':{
...
'noun':['shark','octopus','angelfish','loch ness monster','great old ones in the deep','undiscovered species','shark cage','mermaids','coral','starfish','whales','jellyfish','krill'],
'verb':['swim with dolphins','scuba dive','fish','splash around','use sonar','sail','visit aquariums'],
'gerund':['swimming with dolphins','scuba diving','fishing','splashing around','submarining','using sonar','sailing','visiting aquariums'],
},
  'beard care':{
  'slides':['5 inch beards > 2 inch beards > #noun#','do beards make you #noun#?','flower beards and #noun#','maintain manly stubble by #gerund#','help! my beard is #gerund#!','beard wash: worth giving up #gerund#?','your majestic chin-bush can even let you save #noun# for later enjoyment!','#noun# beards: manliest thing ever?','for thicker beards, try\n1. #gerund#\n2. testosterone supplements\n3. #gerund#','men with beards = #noun#','why did all my hair migrate to my #noun#?','if you have 5 o\'clock shadows by 1, check for #noun#','beard going gray? try #gerund#','#noun# or beard implants?','how often does your beard need to #verb#?','do you have to like #gerund# if you have a majestic beard?\n technically no. but maybe you should anyway.'],
  'noun':['wizard beard','muttonchops','soul patch','neckbeard','handlebar mustache','goatee','pencil mustache'],
